...
export function CustomerLayout() {
  ...
  return (
    <div className="h-[100dvh] w-full bg-bg-light flex flex-col">
      <header className="h-16 shrink-0 border-b border-gray-200 bg-white px-4 md:px-8 flex items-center justify-between z-10 top-0 sticky">
      ...
      <nav className="md:hidden shrink-0 h-[72px] bg-white border-t border-gray-200 flex justify-around p-2 z-50 rounded-t-2xl shadow-[0_-4px_20px_-10px_rgba(0,0,0,0.1)]">
